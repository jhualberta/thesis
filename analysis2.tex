...
\begin{figure}[htbp]
	\subfigure{
		\begin{minipage}[t]{0.45\textwidth}
			\centering
			\includegraphics[width=6.5cm]{muonSolarMcC11.png}
		\end{minipage}
	}   
	\subfigure{ 
		\begin{minipage}[b]{0.3\textwidth}
			\centering
			\includegraphics[width=6.5cm]{muonSolarReconC11.png}
		\end{minipage}
	}
...
\begin{figure}[htbp]
	\subfigure{
		\begin{minipage}[t]{0.45\textwidth}
			\centering
			\includegraphics[width=6.5cm]{muonSolarMcC10.png}
		\end{minipage}
	}   
	\subfigure{ 
		\begin{minipage}[b]{0.3\textwidth}
			\centering
			\includegraphics[width=6.5cm]{muonSolarReconC10.png}
		\end{minipage}
	}
...
\begin{figure}[htbp]
	\subfigure{
		\begin{minipage}[t]{0.45\textwidth}
			\centering
			\includegraphics[width=6.5cm]{muonSolarMcHe6.png}
		\end{minipage}
	}   
	\subfigure{ 
		\begin{minipage}[b]{0.3\textwidth}
			\centering
			\includegraphics[width=6.5cm]{muonSolarReconHe6.png}
		\end{minipage}
	}
