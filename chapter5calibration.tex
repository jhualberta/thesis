...
The energy reconstruction algorithms for the water phase (mentioned in Sect.~\ref{sect:energyFitter}) were applied on the $^{16}$N MC simulations and data. Spectra of the reconstructed energy of the $^{16}$N events are shown in Fig.~\ref{fig:N16energy}, comparing results from the MC and the data.
