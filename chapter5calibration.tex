...
Fig.~\ref{fig:EvsBeta14} shows the relationship between the reconstructed energies ($E_{fit}$) and $\beta_{14}$ values from $^{16}$N central run 107055, comparing the \texttt{MPW} and \texttt{RAT} results from the MC and data respectively. 
