...
The energy fitters for the water phase (mentioned in Sect.~\ref{sect:energyFitter}) were applied to the $^{16}$N MC simulations and data. The fitters converted the NHits into the reconstructed energies. Fig.~\ref{fig:N16nhits} shows the NHits spectra of the $^{16}$N central run 107055, comparing results from the MC and the data.

Spectra of the reconstructed energy of the $^{16}$N events are shown in Fig.~\ref{fig:N16energy}.

\begin{figure}[htbp]
	\centering
	\includegraphics[width=10cm]{N16_nhits_107055.png}
	\caption[NHits spectrum of the $^{16}$N central run 107055.]{NHits spectrum of the $^{16}$N central run 107055. Dashed lines for the MC and solid lines for data; red for the MPW fitter results and black for the \texttt{RAT} results.\label{fig:N16nhits}}	
\end{figure}
...
\begin{figure}[htbp]
   ...
   \subfigure[$^{16}$N run 107055]{\includegraphics[width=8cm]{N16_reconE_107055.png}}
	...
	\caption[Reconstructed energy spectra from the $^{16}$N central run 107055 and 106925.]{Reconstructed energy spectra from the $^{16}$N central run 107055 (upper) and 106925 (lower). For run 107055 (lower), the \texttt{MPW fitter} results and the \texttt{RAT} results are also compared; for run 106925 (lower), the reconstructed data (black dots) are compared to the MC (blue line), both being \texttt{MPW fitter} results. Dashed lines for the MC and solid lines for data; red for the \texttt{MPW fitter} results and black for the \texttt{RAT} results.\label{fig:N16energy}}
\end{figure}
