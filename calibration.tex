...
The relative difference between data and MC of a quantity $q$ is defined as:
\begin{equation}
...
\begin{figure}[!htb]\label{direction_scan}
	...
	\caption{Relative differences of $\beta_M$ and $\beta_S$ as a function of the $^{16}$N source position.}
\end{figure}
