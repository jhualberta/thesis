...
\begin{figure}[!htb]
	...
	$N_{sig} = 64.71\pm9.36$ and $N_{bkg} = 40.00 \pm 6.12$ were obtained with a $\chi^2/ndf = 28.0/31 = 0.903$.}
	\label{ensemble_test}
\end{figure} 
...
\begin{figure}[!htb]
	...
	\caption{Fit pulls for 5000 fake datasets.}
...
\begin{figure}[!htb]
	...
	\caption{Fit biases for 5000 fake datasets.}
...
\begin{figure}[!htb]
	...
	\caption{Fitted results for the $5<E_{fit}<15~MeV$ BDT outputs. $N_{sig}=108.78\pm13.39$ and $N_{bkg}=73.75\pm 17.35$ were obtained with $\chi^2/ndf=3.49$.} \label{wholeDataset_poissonFit_bdt}
\end{figure} 
The fitted results of the BDT outputs give a signal rate of $0.822\pm0.101$ events/kt-day and background rate of $0.56\pm 0.13$ events/kt-day in the energy region $[5,15]~MeV$.

\begin{figure}[!htb]
	\centering
	\includegraphics[width=8cm]{wholedataFit_mlp.pdf}
	\caption{Fitted results for the $5<E_{fit}<15~MeV$ MLP outputs. $N_{sig}=109.24\pm13.38$ and $N_{bkg}=70.96\pm17.11$ were obtained with $\chi^2/ndf=2.98$.}
	\label{wholeDataset_poissonFit_mlp}
\end{figure} 

The fitted results of the MLP outputs gives a signal rate of $0.83\pm0.10$ events/kt-day and background rate of $0.54\pm 0.13$ events/kt-day in the energy region $[5,15]~MeV$.

It can be concluded here that in the $[5,15]~MeV$ energy region, the BDT results are consistent with the MLP results. The estimated background rate is lower than the signal rate, which indicates an extremely low background is achieved for the data.
