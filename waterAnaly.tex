...
Compared to the Super-K measurement (mentioned in Sect.~\ref{sect:superKsolarnu}, Chapter 2): $\Phi_{ES}=(2.345\pm0.014(stat.)\pm 0.036(syst.))\times 10^6~cm^{-2}s^{-1}$\cite{abe2016solar} and the SNO+ 2018 published results: $\Phi_{ES}=(2.53^{+0.31}_{-0.28}(stat.)^{+0.13}_{-0.10}(syst.))\times 10^6~cm^{-2}s^{-1}$\cite{anderson2019measurement}.
