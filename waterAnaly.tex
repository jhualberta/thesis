...
To describe the $\cos\theta_e$ distribution, if integrating from a $\cos\theta_e$ value to $+1$ contains 50\% of the reconstructed events, then this $\cos\theta_e$ is defined as $\cos\theta_{0.5}$. Similarly, $\cos\theta_{0.8}$ and $\cos\theta_{0.9}$ are defined for 80\% and 90\% cases respectively. If these values are large, the $\cos\theta_e$ distribution is sharper and more peaked around +1.
