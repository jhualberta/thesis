...
A remapping of $\cos\theta_{sun}$ by using the Eq.~\ref{remapTheta} was applied on the spectrum for evaluating the systematics. a minus symbol should be applied, and it is found as:
...
\begin{table}[ht]
	...
	\begin{tabular*}{80mm}{c@{\extracolsep{\fill}}cc}
		...
		$E_{resol}$ & ${f_s}^{+0.344158}_{-0.22234}$ \\
