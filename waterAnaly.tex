...
Fig.~\ref{poisson_fitPull} and Fig.~\ref{poisson_fitBias} show the fit pull and biases respectively. The histograms were fitted with Gaussians. For the fitted number of signal events, the fit bases is $-0.06\pm0.06$ for 5000 fake datasets while the fit pull is $-0.42\pm0.45$.
...
Table.~\ref{table:solar_uncertainties} summarizes the systematic errors used for this analysis. These errors were derived from the $^{16}$N calibration analysis, see Chapter 5.
