...
\begin{table}[ht]
	\caption{A comparison of quantitative estimates to the angular resolution for the SNO heavy water, SNO+ wbWLS and the SNO+ pure water cases.\label{tab:quantAngular}}
		\vspace{2mm}
				\centering		
