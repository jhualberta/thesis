...
while the rise time, $t_{rise} = 0.8~ns$ the timing parameters
amplitude


\begin{table}[ht]
	\caption{\label{scint_timing} scintillator $\alpha/\beta$ timing parameters.}	
	{\centering
		\begin{tabular*}{160mm}{c@{\extracolsep{\fill}}ccccccccc}
			\toprule 
			medium & \multicolumn{4}{c}{timing parameters [ns]} & \multicolumn{4}{c}{amplitudes}\\
			\cline{2-5} \cline{6-9}		
			       & $t_1$ & $t_2$ & $t_3$ & $t_4$ & $a_1$ &$a_2$ &$a_3$&$a_4$\\
			\midrule
			LAB + 2g/L PPO \\
			\hline
			...
			LAB + 0.5g/L PPO \\
			\hline
			& 7.19 & 24.81 & 269.87 & -- &0.553 &0.331 &0.116 & --\\
			LAB + 2g/L PPO + Te + 0.5 dda \\
			\hline
			& 7.19 & 24.81 & 269.87 & -- &0.553 &0.331 &0.116 & --\\
			LAB + 2g/L PPO + Te + 0.5 dda\\
			\hline
