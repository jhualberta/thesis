...
\section{Neutrino Mass and Neutrinoless Double Beta Decay}\label{section:directMeasure}
(** will be rephrased and shortened **)
...
There are a few new experiments planned to precisely measure the solar neutrinos in the near future. 

Hyper-Kamiokande is the successor of Kamiokande and Super-K. 
...
(Here will place the experiment results, focusing on SNO+)