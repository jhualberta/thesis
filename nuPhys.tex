...
&\sum_i |U_{\alpha i}|^2|U_{\beta i}|^2 + 2\sum_{i>j}|U_{\beta i}U^*_{\alpha i}U_{\alpha j}U^*_{\beta j}|
 \end{split}
\end{equation}

the orthogonality of the mass eigenstates, $<\nu_j|\nu_i> =\delta_{ij}$.


In natural units and ultra-relativistic case, $L\simeq ct=t$.
...
\[
P_{\alpha\beta}=\delta_{\alpha\beta}-4\sum_{i>j} \Re[U_{\beta i}U^*_{\alpha i}U_{\alpha j}U^*_{\beta j}]\sin^2\frac{\Delta m^2_{ij}L}{4E}+2\sum_{i>j} \Im(U_{\beta i}U^*_{\alpha i}U_{\alpha j}U^*_{\beta j})\sin\frac{\Delta m^2_{ij}L}{2E}
\]
