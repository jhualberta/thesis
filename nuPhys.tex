...
Further expand the second term in Eq.~\ref{oscillationEq2}:
\begin{equation}
 \begin{split}
...
\begin{itemize}
	\item Cosmological measurements. \cite{dvorkin2019neutrino,gerbino2018status,aghanim2020planck}
