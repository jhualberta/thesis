...
solar neutrinos are also a major backgrounds to the $0\nu\beta\beta$ search
...
Interacting Boson Model (IBM), Energy Density Functional Method (EDF) and Projected Hatree-Fock-Bogoliubov Method (PHFB).
