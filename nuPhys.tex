...
\end{equation}
where $G_F$ is the Fermi constant, $\cos\theta_C$ is the Cabibbo angle, $\mathcal{M}_{nucl}$ is the nuclear matrix element, $F(Z,E)$ is the Fermi function describing the electromagnetic interaction between the emitted electron and the final-state nucleus.
