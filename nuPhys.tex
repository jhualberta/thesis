...
and the solar constants $G_{sc}=L_\odot/(4\pi D^2_\odot)$
...
By mathematical aesthetics, Ettore Majorana found a representation which makes all the $\gamma$ matrices be pure imaginary so that the Dirac equation gets rid of complex coefficients\cite{majorana2006symmetric}. Then the Dirac equation can be switched to the Majorana equation: $i\gamma^\mu\partial_\mu\psi-m\psi^c=0$, which also satisfies the Lorentz invariance\cite{zee2010quantum}. Since $\psi$ and $\psi^c$ have opposite charges, this equation should describe a neutral fermion\cite{zee2010quantum}. 
...
\end{equation}
where $G_{PS}$ is a phase space corresponding to  effective coupling constant; $|M_{Nuclear}|$ is the nuclear matrix element describing the nuclear transition and it 

such as the nuclear shell model, quasi-random phase approximation (QRPA) and 
...
$\alpha_1,\alpha_2$ are phase factors and $\alpha_2$ can also be taken as $\alpha_2-\delta_{CP}$.
