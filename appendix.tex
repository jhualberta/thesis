...
\section{Levenberg-Marquardt Method for Minimization}\footnote{This section refers to \cite{press2007numerical}.}
...
The MRQ method is the core algorithm in the MultiPath Fitter Framework for fitting the results. A few parameters can be optimized in practice.
The main parameters are:


 The trade-off between precision of the results and the CPU time is considered. 
\texttt{fTolerance}=0.001;
...
\begin{itemize}
	...
	\item the number of good fits: \texttt{nGood}. 
	\item the maximum iteration number 
