...
Two kinds of calibration sources are used by SNO+: (1) optical sources to measure the detector optical properties and to calibrate the PMTs; and (2) radioactive sources to calibrate the detector energy responses. Different types of radioactive sources are also used to test the performance and systematic uncertainties of event position, direction and energy reconstruction algorithms, as well as the analysis tools for particle identifications.

The deployment of the calibration sources at different positions can help to understand the asymmetries in the detector responses. In geometry, the detector is not perfect symmetric due to the presence of the AV neck, ropes, gaps between the PMTs in the PSUP and differences    





source manipulator system.
...
\cite{jones2011background,walker2016study,dunger2018topological,snop_nim}.
