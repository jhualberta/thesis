...
The unloaded liquid scintillator has fast timing response different timing spectrum for $\alpha$ and $\beta$ events, which enables an $\alpha/\beta$ discrimination. It has very low levels of natural radioactive contaminants such as U, Th and K.

The LAB and the PPO used by SNO+ are of ultra purity. 
...
Two synthesis procedures, the DDA and SOP procedures, are being developed by the SNO+ Tellurium-loading (Te-loading) working groups\cite{biller2017new,teDDA,DDAvsSOP}. These methods can keep the optical transparency of the unloaded scintillator after the Te-loading and the mixture can have a long-term material stability. The total light yield of the full cocktail is expected to be 400 NHits/MeV, which is about 65\% of the unloaded scintillator light yield.

% to the reaction mixture aids inunder exposure to humidity and prevents the formation of precipitates.
...
%depend
%$\alpha$-particle
%high ionization density  quenching, 
