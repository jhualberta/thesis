...
\begin{table}[ht]
	\small{
	\centering
	\caption{Fit results for the whole dataset ($5<E<15$~MeV). Unit: $N$ event; $R$ event/(kt$\cdot$day). \label{table:wholedata_output}}
