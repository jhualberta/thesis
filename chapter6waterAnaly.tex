...
\begin{figure}[htbp]
	...
	\subfigure[Fisher/LD output.]{
		\begin{minipage}[t]{0.5\textwidth}
			\includegraphics[width=7cm]{output_E5to15_Fisher.pdf}
		\end{minipage}
	}
	\subfigure[BDT output.]{
		\begin{minipage}[b]{0.4\textwidth}
			\centering
			\includegraphics[width=7cm]{output_E5to15_BDT.pdf}
		\end{minipage}
	}
	\subfigure[MLP output]{
		\begin{minipage}[b]{0.4\textwidth}
			\centering
			\includegraphics[width=7cm]{output_E5to15_MLP.pdf}
		\end{minipage}
	}
...
\begin{figure}[htbp]
	...
	\subfigure[$4<E_{fit}<15$~MeV.]{
		\begin{minipage}[t]{0.5\textwidth}
			\includegraphics[width=7cm]{ROC_E4to15.pdf}
		\end{minipage}
	}
	\subfigure[$5<E_{fit}<15$ MeV (energy above 5 MeV).]{
		\begin{minipage}[b]{0.43\textwidth}
			\includegraphics[width=7cm]{ROC_E5to15.pdf}
		\end{minipage}
	}
	\subfigure[$4<E_{fit}<5$~MeV.]{
		\begin{minipage}[b]{0.4\textwidth}
			\includegraphics[width=7cm]{ROC_E4to5.pdf}
		\end{minipage}
	}
	\caption[TMVA ROC outputs for signal/background separations by different methods.]{TMVA outputs (ROC) for signal/background separations by different methods, for the $4<E<15$ MeV, $5<E<15$ MeV, and $4<E<5$ MeV testing dataset.\label{fig:energyVsROC}}
\end{figure}
...
As shown in Fig.~\ref{fig:TMVAfractions}, applying the TMVA BDT and MLP selections to each of the 5000 fake datasets, the ratios of the BDT-selected event count to the true event count are $\frac{N_\mathrm{select,BDT}}{N_\mathrm{true,sig}}=0.9766\pm 0.05244$ for signal events, and $\frac{N_\mathrm{total}-N_\mathrm{select,BDT}}{N_\mathrm{true,bkg}}=1.058\pm 0.1001$ for background events (using the histogram mean and root mean square). For the MLP case, the ratios are $\frac{N_\mathrm{select,MLP}}{N_\mathrm{true,sig}}=0.9802\pm0.05059$ and $\frac{N_\mathrm{total}-N_\mathrm{select,MLP}}{N_\mathrm{true,bkg}}=1.050\pm0.09587$. All these ratios fluctuate around 1.0, therefore the TMVA selections are reasonable.
...
\begin{table}[ht]
	...
	\begin{tabular*}{150mm}{c@{\extracolsep{\fill}}cccccc}
		...
		\hline
		BDT &126.0$\pm$12.24 & 39.99 $\pm$ 7.984 & $0.90\pm0.09$ & $0.29\pm0.06$ & 0.1417\\
		MLP &$127.1\pm 12.27$ & $40.88\pm8.025$ & $0.9613\pm0.09281$  & 0.3091$\pm$ 0.06069  & 0.1179\\
		Default & $119.33\pm 11.96$ & $42.67\pm 8.15$ &  $0.90\pm 0.09$ & $0.32\pm0.06$ & 0.19\\
		\bottomrule
	\end{tabular*}
}
\end{table}
