...
In this case, the ray has two intersection points on the sphere and the light path penetrates through the AV. 

If $\Delta\leq0$,
there is no intersection point or only one intersection point at the AV, the light path never passes through the AV sphere.
...
\end{equation}
The time residual is $t_{res} = t_\mathrm{PMT}-t_{transit}-t_0$.
