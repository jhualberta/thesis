...
I choose the one which gives the smallest radial bias based on MC simulations. As shown in Fig.~\ref{plotGroupV}, $n_{eff}=1.40$ gives the smallest radial bias and is adopt for the MC case.
