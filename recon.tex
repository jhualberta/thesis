...
4.466,0.1188,21.54,0.9066,0.541,0.01801
...
\begin{table}[ht]
	\begin{tabular}{cccccccc}%{|p{2.2cm}|p{1.8cm}|p{2cm}|p{2cm}|p{1.8cm}|p{1.1cm}|p{1.1cm}|p{1.1cm}| }
		...
		\hline
		MPW data & 4.47$\pm$0.12 & 21.54 $\pm$0.95 & 0.54$\pm$0.02 & 221.5/159 & 0.964 & 0.744 & 0.410 \\
		\hline
...
\begin{figure}[htbp]\label{fig:diResolVsShell_5MeV}
	\centering
	\includegraphics[width=12cm]{DirResolVsShell.pdf}
	\caption[The biases between the fitted and MC directions.]{The biases between the fitted and MC directions, fitted with the resolution function $P(\cos\theta_e)$ (plotted in red). The MC generated $10^4$ 5-MeV $e^-$ at the detector center.}
\end{figure}
