...
These photons propagate through the detector, and when they reach the PMTs, their time and charge information can get measured and recorded.

By utilizing the time and charge information recorded by the PMTs, reconstruction algorithms attempt to determine the vertex (position and time), direction and energy of an event. A few sets of reconstruction algorithms have been or being developed for the SNO+ event reconstruction. These algorithms are based on different methods and are optimized or coordinated for different SNO+ physics phases. 
