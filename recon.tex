...
The measured parameters are listed in Table.~\ref{tab:measureAmplitude}.
\begin{table}[ht]
...
These Oxford-measured  time profiles were convolved with the PMT time response profile mentioned in Sect.~\ref{sect:waterVertex}, Fig.~\ref{fig:MPW_timingPDF}, thus the timing pdf 
\begin{equation}\label{eq:OxfordTimingPDF}
PDF = f_{optics}(t)\otimes f_{PMT~response}(t-t'),
\end{equation}

I wrote a python tool to The partial fitter was re-coordinated according to these measurements.
