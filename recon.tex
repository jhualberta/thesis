...
\begin{figure}[htbp]\label{fig:partial_scint}
	...
	\caption{Reconstructed positions of the 3-MeV $e^-$ events in the scintillator region.}
\end{figure}
...
\begin{figure}[htbp]\label{fig:partial_water}
	...
	\caption{Reconstructed positions of the 3-MeV $e^-$ events in the water region.}
\end{figure}
