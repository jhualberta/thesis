...
To simplify the calculation, we can drop the second unitary term of $H^f_0$ that is irrelevant to the neutrino flavor transformation. Then including the matter effect term, $H^f_0$ is changed to: 
