...
Therefore, studying neutrinos provides us a deeper knowledge of the nature.
...
To simplify the calculation, we can drop the second unitary term of $H^f_0$ that is irrelevant to the neutrino flavor transformation. Then including the matter effect, $H^f_0$ is changed to: 
